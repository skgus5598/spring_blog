...
<script type="text/javascript">
	...
	function rep() {
		/*
			...
			let form={t(key) : title(value), c (key): contnet(value) }
 			이렇게 쓰는거 대신 아래 serialArray를 이용해서 반복문 쓴거  
		*/
		let form = {};
		...
		*/
		...
		$.ajax({
			...
			type : "POST",
			dataType : "json", 
			data : JSON.stringify(form),  //form을 json형태로 바꾸겠다(내가 보내고자하는 데이터 =form)
